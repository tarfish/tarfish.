...
app.event("member_joined_channel", async ({ event, client }) => {
  try {
    ...
    await client.chat.postMessage({
      ...
      text: `here we have a very long talk about this channel which you probably didn't even sign up for :hs:\n\n*✦ channel lore:*\nthis channel was made in april 2025 when hackclub's <#C088UF12N1Z> event was happening. it was mainly used back then to communicate with his close friends about the chinese culture and tourism blah blah\n\n*✦ channel use:*\nit's mostly used by sarvesh to talk about his life and have fun with huddles (maybe one day when he decides to actually reveal his voice :wink:)\n\n*✦ THANK YOUS :YAY::*\n(from yours truly)\nthank you so much to the people who keep me on track and prevent me from procrastinating from the things that actually matter, a HUGE thank you to the friends i made along the way, and lastly, thank you to *YOU* to taking the effort to join the channel and support me!`
})
